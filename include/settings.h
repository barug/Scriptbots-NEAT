...
public:
     ...
     static float DAMAGE_GRADIENT; // if different from 0 damage made by agents is on a gradient in relationship to herbivor attributes
     ...
     static double BODY_COMPAT_MULT; // how much agent's body attributes influence compatibility
     static double BRAIN_COMPAT_MULT; // how much agent's brain genome compatibility influence overall compatibility
